...
\begin{center}
    {\LARGE \textbf{Lung Disease Dataset Analysis using Python}}\\[0.3cm]
    {\large STAT-4104: Categorical Data Analysis}
\end{center}
...
\begin{center}
    {\LARGE \textbf{One-Way ANOVA: Exercise Programs and Weight Loss}}
\end{center}
...
\begin{center}
    {\LARGE \textbf{Chi-Square Analysis on Nigeria Child Anemia Dataset}}
\end{center}
...
\begin{center}
    {\LARGE \textbf{Fisher's Exact Test: Drug Treatments and Disease Outcome}}
\end{center}
...
\begin{center}
    {\LARGE \textbf{Zero-Inflated Poisson Regression on Fish Catch Data}}
\end{center}
...
\begin{center}
    {\LARGE \textbf{Zero-Truncated Poisson Regression on Hospital Length of Stay}}
\end{center}
...
\begin{center}
    {\LARGE \textbf{Zero-Truncated Negative Binomial Regression on Hospital Length of Stay}}
\end{center}
